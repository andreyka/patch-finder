...
PLAYWRIGHT_ENABLED = _env_flag("PLAYWRIGHT_ENABLED", True)
PLAYWRIGHT_HEADLESS = _env_flag("PLAYWRIGHT_HEADLESS", True)
PLAYWRIGHT_NAV_TIMEOUT = int(os.environ.get("PLAYWRIGHT_NAV_TIMEOUT", "30"))
PLAYWRIGHT_PROXY = os.environ.get("PLAYWRIGHT_PROXY", "").strip() or None
