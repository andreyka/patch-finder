...
MAX_TOOL_MSGS = int(os.environ.get("MAX_TOOL_MSGS", "60"))
TOOL_TRUNC_TOK = int(os.environ.get("TOOL_TRUNC_TOK", "10000"))
NO_PROGRESS_WINDOW = int(os.environ.get("NO_PROGRESS_WINDOW", "3"))
NO_PROGRESS_PATIENCE = int(os.environ.get("NO_PROGRESS_PATIENCE", "1"))
REQUEST_TIMEOUT = int(os.environ.get("REQUEST_TIMEOUT", "30"))
BOOTSTRAP = _env_flag("BOOTSTRAP", True)
BOOTSTRAP_SECTION_TOK_CAP = int(os.environ.get("BOOTSTRAP_SECTION_TOK_CAP", "7000"))
